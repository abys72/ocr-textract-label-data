...
s3 = boto3.resource("s3", config=boto_config, region_name='eu-west-1')
sfn = boto3.client("stepfunctions", config=boto_config, region_name='eu-west-1')
textract = boto3.client("textract", config=boto_config, region_name='eu-west-1')
